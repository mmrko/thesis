...
\vspace{-2.75em}
\begin{table}[ht]
  \caption{The experiment taggants and their pigment proportions. The numbers indicate how many $50\mu l$ of each stock solution was used.}
...
Nine different capture presets were used to capture the taggants. The number of frames, delay, White Balance and ISO were given a fixed value. A description of the parameters listed below is provided to Table \ref{table:camera-parameters}.
