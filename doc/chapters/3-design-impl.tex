...
\end{equation}
\\
Once the candidate fingerprints have been ranked the best matches are selected based on two boundary conditions: the top four candidates that are within a 75\% margin of the best candidate qualify. The values for the boundary conditions are derived from the experiment data analyzed in Chapter \ref{chapter:results}.
