...
\begin{figure}[h!]
  ...
  \caption{The original camera module developed prior to the project included a diffraction grating and a slit. The 3D printed mold used for attaching a smartphone to the module was, however, only designed to fit a Lumia 920.}
