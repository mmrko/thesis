...
1. Taggant samples (a \& b) different in shape and size
  - especially 13SV, 13VP, 24VP and S
2. Taggant S barely visible on the Samsung S4
  - Lumia 1020 has better sensitivity for blue...
3. It is obvious that taggants captured by the Samsung S4 and Lumia 1020 can not be unambiguously compared with another.
  - the size difference is due to the difference in the lens MFD (10 vs 15cm)
