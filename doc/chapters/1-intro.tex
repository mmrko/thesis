...
\begin{itemize}
  \item \textbf{RQ1}: Which factors affect the analysis of photoluminescent material?
  - usability (time constraints \& ambient light)
  - luminophors
  - differences between cameras/vendor APIs
  \item \textbf{RQ2}: Can photoluminescence be leveraged for product authentication purposes?
\end{itemize}
