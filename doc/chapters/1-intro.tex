...
Johdanto selvitt‰‰ samat asiat kuin tiivistelm‰, mutta laveammin. Johdannossa kerrotaan yleens‰ seuraavat asiat
...
\begin{itemize}
	...
	\item \textbf{RQ2}: What are the reasons for and against extending a cloud-based storage to client-side?
\end{itemize}
